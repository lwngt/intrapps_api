...
describe('Post /delete_project', function () {
  ...
  it('project_id is not number', function () {
    request('https://localhost:8181/api/')
      .post('delete_project')
      .type('form')
      .set('secretkey', secretkey)
...
// INSERT INTO `buildings` (`id`, `build_sequece_no`, `vendor_id`, `project_id`, `upload_user_id`, `kind`, `app_name`, `icon`, `current_version`, `min_os_version`, `bundle_id`, `package_name`, `file_name`, `original_file_name`, `plist_file_name`, `release_note`, `enabled`, `created`, `updated`, `unregisted`)
// VALUES
...
// INSERT INTO `user_manage_projects` (`id`, `user_id`, `vendor_id`, `project_id`, `created`, `updated`, `unregisted`)
// VALUES
