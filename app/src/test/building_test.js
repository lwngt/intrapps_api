...
describe('Get /building', function () {
  it('nomal test', function () {
    request('https://localhost:8181/api/')
      .get('building?build_id=' + build_id)
  ...
  it('number of digits for build id is over than 700', function () {
    request('https://localhost:8181/api/')
      .get('building?build_id=' + over_701_string)
      .set('secretkey', secretkey)
      .set('apikey', apikey)
      .timeout({ response: 100000, deadline: 100000 })
      .expect(400)
