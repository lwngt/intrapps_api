...
describe('Get /project', function () {
  ...
  it('project id is wrong', function () {
    request('https://localhost:8181/api/')
      .get('project?project_id=' + '9999')
      .set('secretkey', secretkey)
      .set('apikey', apikey)
      .timeout({ response: 100000, deadline: 100000 })
      .expect(400)
  ...
  it('number of digits for project_id is over than 700', function () {
    request('https://localhost:8181/api/')
      .get('project?project_id=' + over_701_string)
      .set('secretkey', secretkey)
      .set('apikey', apikey)
      .timeout({ response: 100000, deadline: 100000 })
      .expect(400)
